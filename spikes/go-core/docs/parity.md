...
- Shared SQLite: `builds` columns now match the app; `process_samples` and same-file open
  remain — see [`sqlite-packaging.md`](sqlite-packaging.md). `--core-socket` still copies Go
